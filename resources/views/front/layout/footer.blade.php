<div class="footer" id="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                <h4> Les produits Corses </h4>
                <ul>
                    <li> <a href="#"> Le Fromage </a> </li>
                    <li> <a href="#"> La Charcuterie </a> </li>
                    <li> <a href="#"> Le Vin </a> </li>
                    <li> <a href="#"> La Bière </a> </li>
                    <li> <a href="#"> La Myrthe </a> </li>
                    <li> <a href="#"> Les gâteaux </a> </li>
                    <li> <a href="#"> Les huiles essentielles </a> </li>
                </ul>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-6">
                <h4> Informations </h4>
