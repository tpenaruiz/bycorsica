                        ...
                        <div class="wrapper">
                            <div class="preview col-md-3">
                                ...
                                <div class="preview-pic tab-content">
                                    <div class="tab-pane active" id="pic-1"><img class="image_product"
                                                                                 src="http://bycorsica.fr/324-tm_thickbox_default/tapenade-noire-olives-noires-apero.jpg"/>
                                    </div>
                                </div>
                                <br>
                            ...
                            <div class="col-md-4">
                                <div class="bloc">
                                    ...
                                    <div class="cadeau">
                                        <a class="ajax_cadeau"><span><i class="fa fa-heart-o fa-lg">
                                                    &nbsp;&nbsp;&nbsp;</i>Ajouter à ma liste de cadeaux</span></a>
                                    </div>
