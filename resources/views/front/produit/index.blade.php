                        ...
                        <div class="container-fliud">
                            <div class="wrapper row">
                                <div class="preview col-md-3">
                                    ...
                                    <div class="preview-pic tab-content">
                                        <div class="tab-pane active" id="pic-1"><img class="image_product" src="http://bycorsica.fr/324-tm_thickbox_default/tapenade-noire-olives-noires-apero.jpg" /></div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="bloc">
                                        ...
                                        <div class="qte">
                                            {{--Form::open(['method' => 'post', 'url' => route('produit.store', 1)])--}}
                                                {!! Form::number('qte', '', array('class'=>'_inputQte', 'name'=>'qte', 'placeholder' => '1')) !!}
                            ...
                            <div class="row">
                                ...
                                <p class="product_text">
                                    Produit méditerranéen par excellence notre tapenade sera parfaite pour accompagner vos apéritifs
                                    Dégustée sur canapé ou simplement en la tartinant sur du pain .
                                    Mais cette tapenade peut aussi servir de farce pour la volaille. On la retrouve dans de nombreuses recettes de l ile
                                    Fabriqué en corse cette tapenade gorgé de soleil ravira les amateurs de tapas accompagnés de vin rosé corse
                                </p>
                                ...
                                <div class="bigTitle">
                                    <h3 class="title_bloc">LES CLIENTS QUI ONT ACHETÉ CE PRODUIT ONT ÉGALEMENT ACHETÉ...</h3>
                                </div>
